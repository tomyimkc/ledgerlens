...
| `LEDGERLENS_LLM_ENABLED=true` + `OPENAI_API_KEY` (or `ANTHROPIC_API_KEY`) | Enable planner/verifier models — native OpenAI or Anthropic via `LEDGERLENS_LLM_PROVIDER` / model IDs (off by default) |
