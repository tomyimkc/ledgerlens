...
| E-02 | DataHub context is central to the response. | Inspect the fixture context and run the documented deterministic ablation. | `fixtures/incident_commander/catalog.json`, `benchmarks/incident_commander/context-ablation-receipt.json` | Synthetic 120-asset, 24-scenario catalog; context-off is intentionally generic, not a frontier-model comparison. | Meaningful DataHub use; usefulness |
